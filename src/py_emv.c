...
PyMODINIT_FUNC initemv(void)
{
	...
	_INT_CONST(m, EMV_TAG_UNPREDICTABLE_NUMBER);
	...
	_INT_CONST(m, ENV_AUC1_DOMESTIC_CASH);
	_INT_CONST(m, EMV_AUC1_INT_CASH);
	_INT_CONST(m, EMV_AUC1_DOMESTIC_GOODS);
	_INT_CONST(m, EMV_AUC1_INT_GOODS);
	_INT_CONST(m, EMV_AUC1_DOMESTIC_SERVICES);
	_INT_CONST(m, EMV_AUC1_INT_SERVICES);
	_INT_CONST(m, EMV_AUC1_ATM);
	_INT_CONST(m, EMV_AUC1_NON_ATM_TERMINALS);
	_INT_CONST(m, EMV_AUC2_DOMESTIC_CASHBACK);
	_INT_CONST(m, EMV_AUC2_INT_CASHBACK);
